...
import com.bytepoxic.core.web.jsf.converter.AppUserConverter;
...
privileged aspect AppUserConverter_Roo_Converter {
    ...
    declare @type: AppUserConverter: @FacesConverter("com.bytepoxic.core.web.jsf.converter.AppUserConverter");

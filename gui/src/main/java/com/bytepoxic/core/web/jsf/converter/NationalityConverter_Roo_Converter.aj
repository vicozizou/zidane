...
import com.bytepoxic.core.web.jsf.converter.NationalityConverter;
...
privileged aspect NationalityConverter_Roo_Converter {
    ...
    declare @type: NationalityConverter: @FacesConverter("com.bytepoxic.core.web.jsf.converter.NationalityConverter");

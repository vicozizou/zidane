...
import com.bytepoxic.core.web.converter.UserTrackConverter;
...
privileged aspect UserTrackConverter_Roo_Converter {
    ...
    declare @type: UserTrackConverter: @FacesConverter("com.bytepoxic.core.web.converter.UserTrackConverter");

...
import com.bytepoxic.core.web.faces.converter.EmailConverter;
...
privileged aspect EmailConverter_Roo_Converter {
    ...
    declare @type: EmailConverter: @FacesConverter("com.bytepoxic.core.web.faces.converter.EmailConverter");

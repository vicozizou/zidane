...
import com.bytepoxic.core.web.faces.converter.LocationConverter;
...
privileged aspect LocationConverter_Roo_Converter {
    ...
    declare @type: LocationConverter: @FacesConverter("com.bytepoxic.core.web.faces.converter.LocationConverter");

...
package com.bytepoxic.example.jsf.converter;

import com.bytepoxic.example.jsf.converter.FooConverter;
...
privileged aspect FooConverter_Roo_Converter {
    ...
    declare @type: FooConverter: @FacesConverter("com.bytepoxic.example.jsf.converter.FooConverter");

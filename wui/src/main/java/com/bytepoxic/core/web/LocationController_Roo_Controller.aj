...
privileged aspect LocationController_Roo_Controller {
    ...
    void LocationController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("location_creationdate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("location_updatedate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
